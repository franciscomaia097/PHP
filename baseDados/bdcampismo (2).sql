...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Dez-2022 às 13:25
...
INSERT INTO `quotas` (`id`, `username`, `payment_date`, `amount`, `paid`) VALUES
(15, 'socio', '2022-01-01', '100.00', 1),
(16, 'socio', '2022-02-01', '100.00', 1),
(17, 'socio', '2022-03-01', '100.00', 1),
(18, 'socio', '2022-04-01', '100.00', 1),
(19, 'socio', '2022-05-01', '100.00', 0),
(20, 'socio', '2022-06-01', '100.00', 1),
(21, 'socio', '2022-07-01', '100.00', 1);
...
CREATE TABLE `reservas` (
  ...
  `nome_cabana` varchar(255) DEFAULT NULL,
...
INSERT INTO `reservas` (`id`, `nome_utilizador`, `nome_cabana`, `estado`) VALUES
(14, 'beatriz', 'Cabana do Amor', 'Cancelada'),
(15, 'socio', 'Cabana de Campismo', 'Cancelada'),
(16, 'socio', 'Cabana do Amor', 'Cancelada');
